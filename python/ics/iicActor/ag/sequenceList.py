...
class AcquireField(AgSequence):
    ...
    def __init__(self, visitId, designId, exptime, guide, magnitude, doTest=False, **kwargs):
        ...
        self.add(actor='ag', cmdStr='acquire_field',  design_id=designId, visit_id=visitId, exposure_time=exptime,
                 guide=guide, magnitude=magnitude)
...
class AutoguideStart(AgSequence):
    ...
    def __init__(self, visitId, designId, exptime, fromSky, cadence, focus, center, magnitude, doTest=False, **kwargs):
        AgSequence.__init__(self, **kwargs)
        self.add(actor='ag', cmdStr='autoguide start', design_id=designId, visit_id=visitId, exposure_time=exptime,
                 from_sky=fromSky, cadence=cadence, focus=focus, center=center, magnitude=magnitude)