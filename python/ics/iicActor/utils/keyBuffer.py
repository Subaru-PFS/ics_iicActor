...
class KeyBuffer(object):
    ...
    def checkForChanges(self, cb):
        ...
        if self.future != self.current:
            ...
            if self.everConnected and 'pfi' in set(self.current.values()) - set(self.future.values()):
            ...
            # future is always different from current when iic start, that's how I distinguish an actual user change.
            if not self.everConnected:
